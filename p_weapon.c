...
void weapon_grenade_fire (edict_t *ent, qboolean held)
{
	...
	vec3_t	start;
	int		damage = 10; //I changed damage from 125 to 10
	float	timer;
	int		speed;
	float	radius;

	radius = damage+100; //changed 40 --> 100
	if (is_quad)
		damage *= 4;
...
void weapon_shotgun_fire (edict_t *ent)
{
	...
	vec3_t		forward, right;
	vec3_t		offset;
	int			damage = 50; //changed this from 4 gioia
	int			kick = 2; //changed this from 8 gioia
